...
@section('content')
    ...
    <section class="awe-parallax page-heading-demo" style="background-position:100% 12px;"><div class="awe-overlay"></div><div class="container"><div class="blog-heading-content text-uppercase"><h2>БЛОГ</h2></div></div></section>
    <section>
        <div class="container">
                            ...
                            <div class="post-media">
                                <div class="image-wrap image-style">
                                    <a href="{{url('/blog/'.$post->id)}}">
                                        <img src="{{route('file', [$post->filename])}}" alt="" style="height: 100%; width: auto;"></a>
                                </div>
                            </div>
                            <div class="post-body">
                                <div class="post-meta">
                                    <div class="date"><?php echo(date('d ' ,strtotime($post->created_at)) . $monthes[(date('n', strtotime($post->created_at)))] . date(' Y')); ?></div>
                                    <div class="cat">
                                        <ul>
                                            <li>
                                ...
                                <div class="post-link">
                                    <a href="{{url('/blog/'.$post->id)}}" class="awe-btn awe-btn-style2">Читать</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
