                    ...
                    <div class="wrapper wrapper-white">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control selectpicker" name="city_from" style="display: none;"  data-size="10" title='Выберите горож отправления'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control selectpicker" name="food" style="display: none;"  data-size="10" title='Выберите горож отправления'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" placeholder="Количество ночей" name="night">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Отель</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" placeholder="Отель" name="hotel">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea id="ckeditor1" name="short_about_trip"  onkeydown="textCounter2(this.form.doc_desc,this.form.grLenght2,300);" onkeyup="textCounter2(this.form.ckeditor1,this.form.grLenght2,300);"></textarea>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea id="ckeditor" name="full_about_trip"   onkeydown="textCounter2(this.form.full_about_trip,this.form.grLenght1,10000);" onkeyup="textCounter2(this.form.full_about_trip,this.form.grLenght1,10000);"></textarea>
                            ...
                            <!--<div class="form-group">
                                <label class="col-md-3 control-label">Дата путёвки  (путёвка №1)</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control datepicker" name="date">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label"> За что цена</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" placeholder="За что цена" name="for_the_price">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 control-label">Валюта</label>
                                <div class="col-md-8">
                                    <select class="form-control selectpicker" name="currency" style="display: none;"  data-size="10" title='Выберите горож отправления'>

                                        <option value="rub">Бер. руб.</option>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Цена (только цифры без пробелов)</label>
                                <div class="col-md-8">
