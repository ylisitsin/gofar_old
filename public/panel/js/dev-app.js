...
var dev_forms = {
    ...
    /* ./default form functions */
        ...
        /*$("input.file").each(function(){
            var if_title = typeof $(this).attr("title") === "undefined" ? "Добавить" : $(this).attr("title");
        ...
        if($("input.tags").length > 0)
            $("input.tags").tagsInput({width:'auto',height:'auto',defaultText: "Тэг"});
        /* ./tags input */
        ...
        $('#add_pic').click(function(){
            click++;
            if(click <=5){
                $('.pic').append('<input type="file" name="file[]" class="file" accept="image/jpeg,image/png,image/gif"><br>');
            }
